...
review1 = Review.create!(restaurant: restaurant1, reason_of_visit: "booze", quality_of_service: 2,
  noise_level: 1, fits_taste: true, lighting: 1, cleanliness: 2, comment: "This is a review, believe it...",
   user: user1)
